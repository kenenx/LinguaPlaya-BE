...
user1.languages_known.append(language5)
user1.languages_learn.append(language4)
user2.languages_known.append(language4)
user2.languages_learn.append(language5)
